...
public class SCLAlertView: UIViewController {
    ...
    public func showTitle(title: String, subTitle: String, style: SCLAlertViewStyle, closeButtonTitle:String?=nil, duration:NSTimeInterval?, colorStyle: UInt?, colorTextButton: UInt=0xFFFFFF, showTheCloseButton:Bool) -> SCLAlertViewResponder {
        showCloseButton = showTheCloseButton
